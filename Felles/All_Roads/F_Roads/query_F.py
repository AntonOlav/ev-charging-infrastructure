...
query = """
{
  trafficRegistrationPoints(searchQuery: {roadCategoryIds: [F], registrationFrequency: CONTINUOUS}) {
    id
  }
}
"""
...
file_path = r"C:\Users\anton\Desktop\Master-Oppgave\Anton\Kode\All_Roads\JSON\F_IDs.json"
...
filename1 = r"C:\Users\anton\Desktop\Master-Oppgave\Anton\Kode\All_Roads\JSON\volume_F.json"
