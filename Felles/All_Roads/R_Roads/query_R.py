...
query = """
{
  trafficRegistrationPoints(searchQuery: {roadCategoryIds: [R], registrationFrequency: CONTINUOUS}) {
    id
  }
}
"""
...
file_path = r"C:\Users\anton\Desktop\Master-Oppgave\Anton\Kode\All_Roads\JSON\R_IDs.json"
...
filename1 = r"C:\Users\anton\Desktop\Master-Oppgave\Kode\New_Traffic\weekly_data\volume_R.json"
