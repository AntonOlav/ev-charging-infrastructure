...
query = """
{
  trafficRegistrationPoints(searchQuery: {roadCategoryIds: [E], registrationFrequency: CONTINUOUS}) {
    id
  }
}
"""
...
file_path = r"C:\Users\anton\Desktop\Master-Oppgave\Anton\Kode\All_Roads\JSON\E_IDs.json"
...
filename1 = r"C:\Users\anton\Desktop\Master-Oppgave\Anton\Kode\All_Roads\JSON\volume_E.json"
