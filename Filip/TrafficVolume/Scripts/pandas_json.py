...
base_path = r"TrafficVolume_API/TVolume_data"
...
query_2 = """
{
  trafficRegistrationPoints(searchQuery: {roadCategoryIds: [E], isOperational: true, trafficType: VEHICLE} ) {
    id 
    name
    location {
      coordinates {
...
file_path = r"TrafficVolume_API/TVolume_data/point_data_test.json"
...
filename1 = r"TrafficVolume_API/TVolume_data/Volume_data"
