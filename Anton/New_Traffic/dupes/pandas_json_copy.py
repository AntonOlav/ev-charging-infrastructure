...
base_path = r"C:\Users\anton\Desktop\Master-Oppgave\Kode\New_Traffic\JSON_Dupes"

# define the file name
file_name = "ID_Dupes.json"
...
file_path = r"C:\Users\anton\Desktop\Master-Oppgave\Kode\New_Traffic\JSON_Dupes\ID_Dupes.json"
...
# define the GraphQL query, (add "%s" in ID for all )
  query = """
  {
    trafficData(trafficRegistrationPointId: "%s") {
      ...
      volume {
        byDay(from: "2019-01-01T00:00:00+00:00", to: "2019-12-31T00:00:00+00:00") {
          edges {
            node {
              from
              to
...
filename1 = r"C:\Users\anton\Desktop\Master-Oppgave\Kode\New_Traffic\JSON_Dupes\Volume_Dupes.json"
